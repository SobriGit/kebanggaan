...
export const products = [
  ...
  {
    id: "prod-011",
    title: "Bendera Merah Putih Katun Tebal Jahitan Rapi Bendera Indonesia Untuk Tiang Rumah Sekolah Kantor HUT RI 17 Agustus",
    category: "aksesori",
    isFlashSale: false,
    ageBadge: "Semua Umur",
    ...
    soldCount: "4,5rb+",
    sellerBadge: "Star+",
    imageUrl: "/products/bendera.jpg",
    affiliateUrl: "https://s.shopee.co.id/AUsiGEYfiV"
  },
  {
    id: "prod-012",
    title: "bendera umbul umbul background merah putih rempel sicantik",
    category: "aksesori",
    isFlashSale: false,
    ageBadge: "Semua Umur",
    originalPrice: 100000,
    ...
    soldCount: "2,5rb+",
    sellerBadge: "Star+",
    imageUrl: "/products/bendera2.jpg",
    affiliateUrl: "https://s.shopee.co.id/1VxtZKeWB2"
  },
  {
    id: "prod-013",
    title: "PAKET 20 PCS | Bendera Umbul - Umbul Garuda 3 Meter | 8 Mata Gergaji | Warna Merah Putih",
    category: "aksesori",
    isFlashSale: false,
    ageBadge: "Semua Umur",
    originalPrice: 400000,
    discountedPrice: 85959,
    discountPercent: 37,
    rating: 4.8,
    soldCount: "2,rb+",
    sellerBadge: "Star+",
    imageUrl: "/products/bendera3.jpg",
    affiliateUrl: "https://s.shopee.co.id/9ANKjWxfUV"
  },
  {
    id: "prod-014",
    title: "PAKET 20 PCS | Bendera Umbul - Umbul Garuda 3 Meter | 8 Mata Gergaji | Warna Merah Putih",
    ...
    soldCount: "425+",
    sellerBadge: "Star+",
    imageUrl: "/products/bando.jpg",
    affiliateUrl: "https://s.shopee.co.id/1LeTPMLlUe"
  },
];